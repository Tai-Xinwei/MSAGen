...
pip install torch-scatter==2.1.2 -f https://pytorch-geometric.com/whl/torch-2.2.0+cu118.html
pip install torch-sparse==0.6.18 -f https://pytorch-geometric.com/whl/torch-2.2.0+cu118.html
pip install torch-geometric==2.3.0 -f https://data.pyg.org/whl/torch-2.2.0+cu118.html
pip install torch-cluster==1.6.3 -f https://pytorch-geometric.com/whl/torch-2.2.0+cu118.html
