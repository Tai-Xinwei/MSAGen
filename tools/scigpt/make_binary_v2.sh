...
TRAIN_FILES="/blob/v-zequnliu/mix_pretrain/c4,
        ...
        /blob/yinxia/wu2/shared/SFM/SFM.overall.data/ur50/uniref50_2018_03.train.seqs.pended.new.txt,
        ...
        /blob/yinxia/wu2/shared/SFM/SFM.overall.data/X-text/geneannot_protein_desc.txt,
...
TARGET_FOLDER="/home/shufxi/scigptdata/v2"
