...
tasks, dataset, _ = dc.molnet.load_bace_classification(featurizer=featurizer, splitter="scaffold")
...
inst = "Instruction:\nPredict whether the given molecule can inhibit human beta-secretase 1 (BACE-1) or not."
mol_input = "Input:\n<<|mol0|>>"
response = "Response:\n"
