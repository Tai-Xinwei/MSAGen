...
class CopilotModule(PipelineModule):
    ...
    def __init__(self,
        ...
        super(CopilotModule, self).__init__(layers, num_stages, topology, loss_fn, seed_layers, seed_fn, base_seed, partition_method, part_list, activation_checkpoint_interval, activation_checkpoint_func, checkpointable_layers, device)
        ...
        def exec_range_func(start, end):
            ...
            def exec_func(*inputs):
                ...
                for idx, layer in enumerate(self.forward_funcs[start:end]):
                    ...
                    if self.freeze_layer is not None and self.curr_layer in self.freeze_layer:
                        with torch.no_grad():
                            inputs = layer(inputs)
                    else:
                        inputs = layer(inputs)
