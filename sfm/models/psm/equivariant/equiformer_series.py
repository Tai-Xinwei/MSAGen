...
from .qhnet import ConvNetLayer, ExponentialBernsteinRadialBasisFunctions, SelfNetLayer
from .utils import (  # InnerProduct,; NormGate,; get_feasible_irrep,; get_nonlinear,
    construct_o3irrps,
...
#             data.pos, max_radius, data.batch, max_num_neighbors=200
#         )
...
#                 batch_data.pos, 1000, batch_data.batch, max_num_neighbors=1000
#             )
#             batch_data["non_diag_hamiltonian"] = batch_data["non_diag_hamiltonian"][
#                 full_edge_index[0] > full_edge_index[1]
#             ]
#             batch_data["non_diag_mask"] = batch_data["non_diag_mask"][
#                 full_edge_index[0] > full_edge_index[1]
#             ]
...
#             full_edge_vec = (
#                 batch_data.pos[full_edge_index[0].long()]
#                 - batch_data.pos[full_edge_index[1].long()]
#             )
#             full_edge_rbf = (
#                 self.radial_basis_functions(full_edge_vec.norm(dim=-1).unsqueeze(-1))
#                 .squeeze()
#                 .type(batch_data.pos.type())
#             )
...
class Equiformerv2SO2(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.nonlinear_gates = {1: "ssp", -1: "abs"}
        self.num_fc_layer = 1
        self.max_neighbors = kwargs.get("max_neighbors", 500)
