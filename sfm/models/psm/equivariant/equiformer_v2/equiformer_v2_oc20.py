...
class EquiformerV2_OC20(BaseModel):
    ...
    def forward(self, data):
        ...
        data.cell = torch.zeros(data.num_nodes, 3, 3).to(self.device)
...
class EquiformerV2_OC20Backbone(nn.Module):  # BaseModel
    ...
    def __init__(
        ...
        self.unifiedtokentoembedding = nn.Linear(
            self.sphere_channels, self.sphere_channels_all
        )
    ...
    def forward(self, data):
        ...
        # edge_distance_vec = edge_distance_vec[:, [1, 2, 0]]
