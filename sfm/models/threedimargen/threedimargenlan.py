...
from .modules.threedimargenlan_modules import ThreeDimARGenLan, ThreeDimARGenModelPP


class ThreeDimARGenLanModel(Model):
    """
    ...
    def __init__(self, config, loss_fn=None, not_init=False):
        ...
        if (
            ...
            self.net = ThreeDimARGenLan(config)
    ...
    def compute_loss(self, model_output, batch_data) -> ModelOutput:
        ...
        cross_entropy = CrossEntropyLoss(
            reduction="mean", ignore_index=self.config.pad_token_id
        )
        loss = cross_entropy(
