...
from sfm.models.genegpt.genegpt_config import GenegptConfig
from sfm.models.llama2.llama_modules import LlamaEmbeddingsBase
from sfm.pipeline.accelerator.dataclasses import ModelOutput
from sfm.utils.pipelinemode import pipemode


class GeneGPTEmbeddingsPP(LlamaEmbeddingsBase):
    def __init__(self, config: GenegptConfig, learnable_cutoff: int = 0):
...
class GeneGPTBioEmbeddingsPP(LlamaEmbeddingsBase):
    def __init__(self, config: GenegptConfig, learnable_cutoff: int = 0):
        super().__init__(config, learnable_cutoff=learnable_cutoff)
...
class AdaLlamaHead(torch.nn.Module):
    def __init__(self, config: GenegptConfig, learnable_cutoff: int = 32001):
        super().__init__()
        self.config = config
