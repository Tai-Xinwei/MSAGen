...
from sfm.models.psm.loss.mae3ddiff import DiffMAE3dCriterions, PolicyGradientLoss
...
from sfm.models.psm.modules.rl_reward import RLreward
from sfm.models.psm.psm_optimizer import AdamFP16
from sfm.models.psm.psmmodel_rl import PSMModel_RL
...
class Config(DistributedTrainConfig, PSMConfig):
    ...
    # psm_finetune_noise_mode: Optional[str] = None
...
def main(args: DictConfig) -> None:
    ...
    if args.psm_finetuneRL_mode:
        loss_fn = PolicyGradientLoss
        reward_model = RLreward
    else:
        reward_model = None

    model = PSMModel_RL(args, loss_fn, reward_model, psm_finetune_head=finetune_module)
