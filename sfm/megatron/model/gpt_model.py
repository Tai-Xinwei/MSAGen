...
from .language_model import EmbeddingPipe, get_language_model, parallel_lm_logits
from .module import MegatronModule, float16_to_fp32, fp32_to_float16
from .transformer import LMHeadPipe, ParallelTransformerLayerPipe
...
class GPTModelPipe(PipelineModule, MegatronModule):
    ...
    def __init__(self, config, num_tokentypes=0, parallel_output=True):
        ...
        if args.normalization == "layernorm":
            ...
            self.specs.append(
                LayerSpec(MixedFusedRMSNorm, args.hidden_size, args.layernorm_epsilon)
            )
