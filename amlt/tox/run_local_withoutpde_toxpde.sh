...
mkdir -p /blob/pfmexp/output/pfmdiff100M768_prob1522_m5_bs256_ddpmnoise_v1_pi_wopde_score
mkdir -p /blob/pfmexp/output/pfmdiff100M768_prob1522_m5_bs256_ddpmnoise_v1_pi_wopde_score/checkpoints
mkdir -p ./output
...
export WANDB_RUN_NAME="withoutPDE_baseline"
export log_interval=100
export OMPI_COMM_WORLD_SIZE=1
export loadcheck_path=/blob/pfmexp/output/pfmdiff100M768_prob1522_m5_bs256_ddpmnoise_v1_pi_wopde_score/checkpoints
export data_path=/blob/data/afdb/48organism1m.lmdb/
export save_dir=/blob/pfmexp/output/pfmdiff100M768_prob1522_m5_bs256_ddpmnoise_v1_pi_wopde_score/checkpoints
