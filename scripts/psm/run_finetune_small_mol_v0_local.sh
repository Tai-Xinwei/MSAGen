...
export diffusion_noise_std=0.0
...
export wandb_run_name='ft_yu_md22_fix_sample_300M_random'

export backbone='graphormer'
export backbone_config='graphormer'
...
export loadcheck_path='../sfm_data/pubchem-pm6-diffusion-molecule-protein-periodic-8xG8-fp32-ddp-unified-sampler-continued-fastpreprocess-20240607-2159/checkpoint_E2_B9070.pt'
export save_dir="../sfm_data/checkpoints/$wandb_run_name"
python setup_cython.py build_ext --inplace
bash ./scripts/psm/finetune_psm_small_mol_v0.sh
