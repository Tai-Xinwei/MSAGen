...
[ -z "${num_pred_attn_layer}" ] && num_pred_attn_layer=10
...
[ -z "${save_epoch_interval}" ] && save_epoch_interval=10000
...
[ -z "${data_path}" ] && data_path='/home/v-xixianliu/work/xixian/data/matter-sim-15M'
# [ -z "${data_path_list}" ] && data_path_list='AFDB50-plddt70.lmdb'
# [ -z "${dataset_name_list}" ] && dataset_name_list='afdb'
[ -z "${data_path_list}" ] && data_path_list='coredataset-v20230731'
...
[ -z "${pbc_expanded_num_cell_per_direction}" ] && pbc_expanded_num_cell_per_direction=4
