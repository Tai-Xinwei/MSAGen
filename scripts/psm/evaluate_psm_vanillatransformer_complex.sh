...
[ -z "${loadcheck_path}" ] && loadcheck_path="/data/peiran/output/global_step182000/mp_rank_00_model_states.pt"
...
torchrun $DISTRIBUTED_ARGS sfm/tasks/psm/evaluate_psm_complex.py \
