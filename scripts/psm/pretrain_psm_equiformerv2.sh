...
[ -z "${data_path_list}" ] && data_path_list="oc20/unref/train/data.0000.lmdb"
[ -z "${dataset_name_list}" ] && dataset_name_list="oc20"
...
[ -z "${wandb_group}" ] && wandb_group=Lin_psm_dev
[ -z "${wandb_team}" ] && wandb_team=ai4s-sfm
[ -z "${wandb_project}" ] && wandb_project=psm_dev
[ -z "${wandb_key}" ] && wandb_key=local-87ea2686fd085c711a860f79583933bd86bdbd23
