...
export data_path_list='PubChemQC-B3LYP-PM6,AFDB50-plddt70.lmdb'
export dataset_name_list='pm6,afdb'
export dataset_split_raito='0.5,0.5'
export dataset_micro_batch_size='128,12'
export fp16=False
...
export loadcheck_path="/casp/jianwzhu/workspace/SFM_Evaluation/run_sfm/sfmblob/pfmexp/output/psmv1_vt_v4/checkpoints/global_step144189/mp_rank_00_model_states.pt"
export save_dir="/casp/jianwzhu/workspace/SFM_Evaluation/run_sfm/sfmblob/pfmexp/output/psmv1_vt_v4/checkpoints/global_step144189/prediction"
