...
[ -z "${loadcheck_path}" ] && loadcheck_path="/data/peiran/blob/sfmarca100/sfm/sfmexpresults/peiran/psmv1_dit_v13_1b/checkpoints/global_step90000/mp_rank_00_model_states.pt"
...
torchrun $DISTRIBUTED_ARGS sfm/tasks/psm/finetune_psm_rl.py \
