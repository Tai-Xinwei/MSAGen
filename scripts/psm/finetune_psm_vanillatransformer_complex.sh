...
# [ -z "${data_path}" ] && data_path='/home/v-zhezhan/preprocessed/'
[ -z "${data_path}" ] && data_path='/fastdata/peiran/psm/preprocessed.large'
...
[ -z "${data_path_list}" ] && data_path_list='pdb'
[ -z "${dataset_name_list}" ] && dataset_name_list='pdb'
[ -z "${dataset_split_raito}" ] && dataset_split_raito='0.97'
...
# [ -z "${loadcheck_path}" ] && loadcheck_path="/home/v-zhezhan/mp_rank_00_model_states.pt"
# [ -z "${save_dir}" ] && save_dir='/home/v-zhezhan/checkpoints'

[ -z "${loadcheck_path}" ] && loadcheck_path="/data/peiran/ckpt/psm/psmv1_vt_v8/global_step389895/mp_rank_00_model_states.pt"
[ -z "${save_dir}" ] && save_dir='/data/peiran/output/'

[ -z "${wandb_group}" ] && wandb_group=psm_dev_vt_complex
...
torchrun $DISTRIBUTED_ARGS sfm/tasks/psm/finetune_psm_complex.py \
