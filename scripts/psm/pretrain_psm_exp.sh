...
# [ -z "${decoder_ffn_dim}" ] && decoder_ffn_dim=3072
...
[ -z "${complex_mode_prob}" ] && complex_mode_prob='0.9,0.0,0.1,0.0' #'0.6,0.2,0.1,0.1' #sss prob of independent mask_pos==mask_type, mask_pos==full, mask_type==full
