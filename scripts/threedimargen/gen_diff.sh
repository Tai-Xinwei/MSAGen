CKPT=/msralaphilly2/ml-la/renqian/SFM/threedimargen/outputs/3dargendiff_v0.1_base_mp_nomad_qmdb_ddp_epoch50_warmup8000_lr1e-4_wd0.1_bs256/checkpoint_E38.pt
...
if [ -f ${OUTPUT} ]; then
    ...
    python sfm/tasks/threedimargen/gen_threedimargendiff.py \
