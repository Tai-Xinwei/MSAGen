...
torchrun $DISTRIBUTED_ARGS sfm/tasks/threedimargen/train_threedimargenlan.py \
    ...
    --train_data_path /hai1/SFM/threedimargen/data/materials_data/mp_nomad_qmdb_train_slices.txt \
    --valid_data_path /hai1/SFM/threedimargen/data/materials_data/carbon-24_perov-5_mp-20_val_slices.txt \
