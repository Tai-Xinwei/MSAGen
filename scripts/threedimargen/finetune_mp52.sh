NAME=3dargenlan_v0.1_base_ft_mp_52_ddp_noniggli_base_epoch10_warmup1_lr1e-5_wd0.1_bs16

python sfm/tasks/threedimargen/train_threedimargenlan.py \
    --dict_path sfm/data/threedimargen_data/dict_lan.txt \
    --train_data_path /hai1/SFM/threedimargen/data/materials_data/mpts-52_train.jsonl \
    --valid_data_path /hai1/SFM/threedimargen/data/materials_data/mpts-52_test.jsonl \
