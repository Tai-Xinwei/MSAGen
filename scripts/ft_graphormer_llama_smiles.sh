...
[ -z "${dataset_ratios}" ] && dataset_ratios='1'

[ -z "${loadcheck_path}" ] && loadcheck_path="."
[ -z "${output_path}" ] && output_path='/mnt/shiyu/models/sfm-copilot/'
...
[ -z "${llm_model_name_or_path}" ] && llm_model_name_or_path="/mnt/shiyu/models/converted/7B-pp/"
...
deepspeed --num_gpu=4 sfm/tasks/ft_graphormer_llama_inst.py \
  --num-classes 1 \
  --encoder_attention_heads $num_head \
  --encoder_layers $layers \
  --encoder_ffn_embed_dim $ffn_size \
