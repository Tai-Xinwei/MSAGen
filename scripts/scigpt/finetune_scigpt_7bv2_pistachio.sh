...
[ -z "${train_data_path}" ] && train_data_path='/blob/guoqing/pistachio_2023Q2_v2_o_smiles_preprocessed/train_augmentation_40.txt'
[ -z "${valid_data_path}" ] && valid_data_path='/blob/guoqing/pistachio_2023Q2_v2_o_smiles_preprocessed/valid.txt'
[ -z "${save_dir}" ] && save_dir='/blob/shufxi/scigpt/7bv2/stageB/finetune/pistachio'
[ -z "${seed}" ] && seed=42
...
[ -z "${total_num_steps}" ] && total_num_steps=55456
...
[ -z "${val_batch_interval}" ] && val_batch_interval=4000
echo -e "\n\n"
echo "==================================MP==========================================="
...
torchrun $DISTRIBUTED_ARGS \
    ...
    --save_batch_interval "$val_batch_interval" \
