...
[ -z "${train_data_path}" ] && train_data_path='/blob/shufxi/data/coolent/scigraph_bp.txt'
[ -z "${save_dir}" ] && save_dir='checkpoints/scigpt_7bv2_ft'
[ -z "${seed}" ] && seed=42
...
[ -z "${total_num_steps}" ] && total_num_steps=220
[ -z "${warmup_num_steps}" ] && warmup_num_steps=22
