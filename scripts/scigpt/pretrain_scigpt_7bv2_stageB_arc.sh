...
[ -z "${total_num_steps}" ] && total_num_steps=34880 # 6976 * 5 Epochs
...
# When use 32 GPU and pipeline stage 2, the acc steps is 1k/ (32/2) = 64
...
[ -z "${train_data_path}" ] && train_data_path='/nfs/users/shufxi/data/scigpt/v2/train.npy'
[ -z "${valid_data_path}" ] && valid_data_path='/nfs/users/shufxi/data/scigpt/v1/valid_sample.npy'
[ -z "${loadcheck_path}" ] && loadcheck_path='/nfs/users/shufxi/scigpt/7bv2/stageA/global_step3999'
[ -z "${save_dir}" ] && save_dir='/nfs/users/shufxi/scigpt/7bv2/stageB'
