...
[ -z "${train_data_path}" ] && train_data_path="/blob/yinxia/wu2/shared/SFM/SFM.overall.data/instruction_tuning/round1_demo_instruction.tsv"
...
[ -z "${save_dir}" ] && save_dir="/blob/shufxi/scigpt/7bv3/inst/$(date +%Y%m%d%H%M%S)"
[ -z "${seed}" ] && seed=46
