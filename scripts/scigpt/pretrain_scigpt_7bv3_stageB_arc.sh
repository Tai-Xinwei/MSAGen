...
[ -z "${total_num_steps}" ] && total_num_steps=139520 # 6976 * 20 Epochs
...
[ -z "${train_batch_size}" ] && train_batch_size=1120
[ -z "${val_batch_size}" ] && val_batch_size=1120

# When use 224 GPU and pipeline stage 2, the acc steps is 1k/ (224/2) = 10
[ -z "${gradient_accumulation_steps}" ] && gradient_accumulation_steps=10
[ -z "${save_epoch_interval}" ] && save_epoch_interval=1
[ -z "${save_batch_interval}" ] && save_batch_interval=3000
...
[ -z "${train_data_path}" ] && train_data_path='/hai1/shufxi/data/scigpt/v3/train.npy'
[ -z "${valid_data_path}" ] && valid_data_path='/hai1/shufxi/data/scigpt/v1/valid_sample.npy'
[ -z "${loadcheck_path}" ] && loadcheck_path='/hai1/shufxi/scigpt/7bv3/stageA/global_step3999'
[ -z "${save_dir}" ] && save_dir='/hai1/shufxi/scigpt/7bv3/stageB'
