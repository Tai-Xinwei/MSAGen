...
[ -z "${max_lr}" ] && max_lr=2.4e-5  # LLAMA2 use 3e-4, let's use smaller lr
...
[ -z "${loadcheck_path}" ] && loadcheck_path='/hai1/shufxi/scigpt/7bv2/stageA/global_step3999'
[ -z "${save_dir}" ] && save_dir='/hai1/shufxi/scigpt/7bv2/stageB'
