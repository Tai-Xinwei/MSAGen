...
[ -z "${train_data_path}" ] && train_data_path="/hai1/kaiyuan/scigpt/ur50/data/sampled_200k_len300.txt"
...
[ -z "${save_dir}" ] && save_dir="/blob/shufxi/scigpt/7bv3/prot/$(date +%Y%m%d%H%M%S)"
[ -z "${seed}" ] && seed=46
