# -*- coding: utf-8 -*-
# From gist.githubusercontent.com/jeffra/b5e80466b4c86be00ea3b6f130fb7a36/raw/638464cef96636a31f777d041ecc43a7bb220d1d/all_reduce_bench_v2.py
...
def run(local_rank):
    ...
    if dist.get_rank() == 0:
        print(
            "tput_avg (Gbps):", tput_avg.item(), "busbw_avg (Gbps):", busbw_avg.item()
        )
    dist.barrier()
