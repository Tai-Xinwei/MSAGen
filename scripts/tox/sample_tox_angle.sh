...
[ -z "${mode_prob}" ] && mode_prob='0.0,1.0,0.0' # prob of independent mask_pos==mask_type, mask_pos==full, mask_type==full
[ -z "${strategy}" ] && strategy=Zero1

[ -z "${data_path}" ] && data_path='/home/v-lijunzhe/ToxPDE/data_test/'
[ -z "${loadcheck_path}" ] && loadcheck_path='/home/v-lijunzhe/ToxPDE/model_test/mp_rank_00_model_states.pt'
[ -z "${save_dir}" ] && save_dir='/home/v-lijunzhe/ToxPDE/output_angle_sample'
...
torchrun $DISTRIBUTED_ARGS sfm/tasks/tox/sample_tox_angle.py \
