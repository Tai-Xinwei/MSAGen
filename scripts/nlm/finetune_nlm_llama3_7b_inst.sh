...
[ -z "${dict_path}" ] && dict_path='/home/t-kaiyuangao/sfm-container/llama/Meta-Llama-3-8B/original'
# [ -z "${train_data_path}" ] && train_data_path='/data/peiran/blob/hai1data/sfm/nlm/llama3_processed_data/v5_train/train.npy'
[ -z "${train_data_path}" ] && train_data_path='/home/t-kaiyuangao/workspace/data/sfm_llama3_inst/overall_inst_5k_train.txt'
[ -z "${valid_data_path}" ] && valid_data_path='/home/t-kaiyuangao/workspace/data/sfm_llama3_inst/overall_inst_5k_valid.txt'
[ -z "${loadcheck_path}" ] && loadcheck_path='/home/t-kaiyuangao/sfm-container/nlm/output/llama3_stageB_tp2/global_step47999'
[ -z "${save_dir}" ] && save_dir='./local_results'
...
[ -z "${wandb_key}" ] && wandb_key=7a4eda8c60b1015329d5dc64869f33d57dde64db
