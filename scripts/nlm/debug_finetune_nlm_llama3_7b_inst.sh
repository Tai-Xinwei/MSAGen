...
do
  ...
  do
    ...
    max_lr=${max_lr}  # LLAMA2 use 3e-4, let's use smaller lr
    ...
    gradient_accumulation_steps=$(($train_batch_size/4))
    ...
    export WANDB_RUN_NAME=inst_0617_full_bsz${bsz}_lr${max_lr}_0621
    ...
    train_data_path='/blob/yinxia/wu2/shared/SFM/SFM.overall.data/SFMMolInstruct.20240617/overall.train.20240621'
    valid_data_path='/blob/yinxia/wu2/shared/SFM/SFM.overall.data/SFMMolInstruct.20240524/overall.instructval.filt'
    loadcheck_path='/sfm/peiran/output/llama3_stageB_G256/global_step42860'
    save_dir=/sfm/kaiyuan/results/nlm/inst/${WANDB_RUN_NAME}
    finetune_from_checkpoint_dir='/sfm/peiran/output/llama3_stageB_G256/global_step42860' # '/sfm/peiran/output/llama3_stageB_G256/global_step42860' #'/home/t-kaiyuangao/workspace' #'/home/t-kaiyuangao/sfm-container/nlm/output/llama3_stageB_tp2'
    finetune_from_checkpoint_id='global_step42860'
    ...
    wandb_group=nlm_llama3_inst
    wandb_team=ai4s-sfm
    wandb_project=nlm_llama3_inst
    ...
    set -x
    torchrun $DISTRIBUTED_ARGS sfm/tasks/nlm/finetune_nlm3d_inst.py \
