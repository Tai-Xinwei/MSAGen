...
[ -z "${dict_path}" ] && dict_path='/data/peiran/blob/hai1data/mfm2/shufxi/Mixtral-8x7B-v0.1'
...
[ -z "${loadcheck_path}" ] && loadcheck_path='/data/peiran/blob/hai1data/mfm2/shufxi/Mixtral-8x7B-v0.1'
