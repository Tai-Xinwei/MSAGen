...
[ -z "${model_type}" ] && model_type="genegpt"
...
[ -z "${train_batch_size}" ] && train_batch_size=384
[ -z "${val_batch_size}" ] && val_batch_size=384
...
[ -z "${train_data_path}" ] && train_data_path='/home/v-zekunguo/nlm/zekun/gene/data/160klmdb_valid_lmdb'
[ -z "${valid_data_path}" ] && valid_data_path='/home/v-zekunguo/nlm/zekun/gene/data/160klmdb_valid_lmdb'
[ -z "${loadcheck_path}" ] && loadcheck_path='/home/v-zekunguo/nlm/zekun/gene/checkpoints/1b6kmer4k_3d/global_step10000'
[ -z "${save_dir}" ] && save_dir='/home/v-zekunguo/nlm/zekun/gene/checkpoints/1b6kmer4k_3d_1'
...
[ -z "${tokens_per_sample}" ] && tokens_per_sample=8192
...
set -x
torchrun $DISTRIBUTED_ARGS sfm/tasks/genegpt/pretrain_genegpt_3d.py \
