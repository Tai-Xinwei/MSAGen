...
[ -z "${train_data_path}" ] && train_data_path='/home/v-zekunguo/zekun_data/gene/lmdb/GCF_000001405.40_GRCh38.p14_genomic.fna.lmdb'
[ -z "${valid_data_path}" ] && valid_data_path='/home/v-zekunguo/zekun_data/gene/lmdb/GCF_000001405.40_GRCh38.p14_genomic.fna.lmdb'
# [ -z "${loadcheck_path}" ] && loadcheck_path='/hai1/ds_dataset/llama2/llama-2-7b'
[ -z "${save_dir}" ] && save_dir='/home/v-zekunguo/data/v-zekunguo/gene/checkpoints/1b6kmer'
