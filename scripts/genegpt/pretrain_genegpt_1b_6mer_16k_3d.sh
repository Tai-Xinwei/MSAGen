...
[ -z "${train_data_path}" ] && train_data_path='/home/v-zekunguo/blobdata/v-zekunguo/gene/data/160klmdb/valid_lmdb'
[ -z "${valid_data_path}" ] && valid_data_path='/home/v-zekunguo/blobdata/v-zekunguo/gene/data/160klmdb/valid_lmdb'
# [ -z "${loadcheck_path}" ] && loadcheck_path='/hai1/ds_dataset/llama2/llama-2-7b'
[ -z "${save_dir}" ] && save_dir='/home/v-zekunguo/blobdata/v-zekunguo/gene/checkpoints/1b6kmer16k'
...
[ -z "${max_position_embeddings}" ] && max_position_embeddings=16348
[ -z "${max_tokens}" ] && max_tokens=16348
