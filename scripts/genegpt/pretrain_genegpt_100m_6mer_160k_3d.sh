...
[ -z "${warmup_num_steps}" ] && warmup_num_steps=1500
...
[ -z "${dict_path}" ] && dict_path='/home/v-zekunguo/hai1data/llama/Meta-Llama-3-8B/original'
[ -z "${train_data_path}" ] && train_data_path='/home/v-zekunguo/data/v-zekunguo/gene/data/160klmdb/valid_lmdb'
[ -z "${valid_data_path}" ] && valid_data_path='/home/v-zekunguo/data/v-zekunguo/gene/data/160klmdb/valid_lmdb'
# [ -z "${loadcheck_path}" ] && loadcheck_path='/hai1/ds_dataset/llama2/llama-2-7b'
[ -z "${save_dir}" ] && save_dir='/home/v-zekunguo/data/v-zekunguo/gene/checkpoints/100m6kmer160k'
...
[ -z "${max_position_embeddings}" ] && max_position_embeddings=163480
[ -z "${max_tokens}" ] && max_tokens=163480
[ -z "${tokens_per_sample}" ] && tokens_per_sample=163480
